package id.rdev.notespenjualan.network

import id.rdev.notespenjualan.activity.data_barang.data.ResultDataBarang
import id.rdev.notespenjualan.activity.login.data.ResultLogin
import id.rdev.notespenjualan.activity.penjualan.data.ResultKeranjang
import id.rdev.notespenjualan.activity.penjualan.data.ResultSearchBarang
import id.rdev.notespenjualan.activity.report.detail.data.ResultItemKeranjang
